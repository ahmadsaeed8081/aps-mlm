   ...
   async function Register(option)
    {
       ...
       if(props.isRegister)
       {
         alert("You are already a registered memeber of APS community");
         return;
       }
            ...
            <div className=" col-lg-6  col-md-12  p-0">
              <div className="  tw-bg-register_bg sm:tw-p-16 tw-p-5">
                ...
                <p className=" tw-text-white tw-text-xl sm:tw-text-left tw-text-center">
                  APS is the flagship of decentralized systems, offering
            ...
            <div className=" col-lg-6 col-md-12">
              <div className="  sm:tw-text-left tw-text-center sm:tw-p-16 tw-p-5">
                ...
                <div className=" tw-flex tw-gap-3.5">
                  <button onClick={() => setSelectedOption("yes")} className={`tw-border ${selectedOption==='yes'?' tw-bg-[#f0c238]  tw-text-black':' tw-text-white'}  tw-py-4 tw-font-medium tw-text-xl tw-border-[#f0c238] tw-w-full tw-rounded-lg tw-transition-all tw-duration-300 hover:tw-bg-[#f0c238] hover:tw-text-black`}>
                    Yes
                  </button>
                  <button   onClick={() => setSelectedOption("no")} className={`tw-border ${selectedOption==='no'?' tw-bg-[#f0c238]  tw-text-black':' tw-text-white'}  tw-py-4 tw-font-medium tw-text-xl tw-border-[#f0c238] tw-w-full tw-rounded-lg tw-transition-all tw-duration-300 hover:tw-bg-[#f0c238] hover:tw-text-black`}>
                    No
                  </button>
                </div>
        ...
        {selectedOption === "yes" ? (
          <>
           ...
           <div className=" tw-pb-5">
             ...
             />
              ...
              <button  
              onClick={()=>Register(0)}
              className={`tw-border tw-text-black tw-py-4 tw-font-poppins tw-font-medium tw-text-xl tw-border-[#f0c238] tw-w-full tw-rounded-lg tw-transition-all tw-duration-300 tw-bg-[#f0c238] hover:tw-text-black`}>
                  Register
                  </button>
          </>
        ) : selectedOption === "no" ? (
          ...
          <>
            <h5 className="tw-text-white tw-font-poppins ">
              Need help using the Apesrun.com platform?
            </h5>
            <p className="tw-font-normal tw-text-white tw-font-poppins tw-py-3">
              Get professional support from Apesrun.com specialists in the online chat.
            </p>
