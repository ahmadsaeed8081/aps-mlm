...
const Hero = (props) => {
 ...
 function checkLogin()
 {
    ...
    if(props.isRegister)
    {
      alert("You are not a register memeber, Kindly Register yourself in the APS community");
      return;
    }
        ...
        <div className="row    sm:tw-text-left tw-text-center g-5 tw-items-center">
          <div className="col-lg-6 col-md-12">
            <h1 className="  text-white  tw-font-zen-dots  md:tw-text-5xl sm:tw-text-4xl tw-text-2xl">
              ...
              Welcome to <span className=" gradient-text tw-font-zen-dots   md:tw-text-5xl sm:tw-text-4xl tw-text-2xl">ApesRun.com - </span> 100% Blockchain
             
            </h1>
            <p className=" tw-text-white sm:tw-text-start tw-text-center    tw-font-extralight tw-leading-7 tw-pt-4 tw-text-lg t">
            Are you ready to take control of your financial future? Apesrun.com offers a revolutionary income system powered by blockchain technology,
            </p>
          ...
          <div className="col-lg-6 col-md-12">
            <div className=" row">
              ...
              <img src={require('../../assets/images/hero.jpeg')} alt="" />
              </div>
            </div>
          </div>
        </div>
